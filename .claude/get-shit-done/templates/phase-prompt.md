...
<!-- For checkpoint task examples and patterns, see @/Users/christian/git-repos/OCC-github/development_environment/security_solution/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/christian/git-repos/OCC-github/development_environment/security_solution/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/christian/git-repos/OCC-github/development_environment/security_solution/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/christian/git-repos/OCC-github/development_environment/security_solution/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
