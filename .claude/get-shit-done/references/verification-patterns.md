...
**@/Users/christian/git-repos/OCC-github/development_environment/security_solution/.claude/get-shit-done/references/checkpoints.md** → `<automation_reference>` section
