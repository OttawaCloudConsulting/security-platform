...
**Plans**: 7 plans
- [ ] 17-01-PLAN.md — Cut the phase branch, author the offline static upload gate, and grant `security-events: write` at the calling job and the callee
- [ ] 17-02-PLAN.md — Replace the `sca` job's `trivy convert` with a direct `trivy fs --format sarif` run and mirror it in the smoke gate with a ROOTPATH regression guard
...
| 17. SARIF Upload and Artifact Retention | v2.0 | 0/7 | Planned | - |
